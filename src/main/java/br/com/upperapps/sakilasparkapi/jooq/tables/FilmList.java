...
import br.com.upperapps.sakilasparkapi.jooq.enums.FilmListRating;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.FilmListRecord;
...
public class FilmList extends TableImpl<FilmListRecord> {
    ...
    private static final long serialVersionUID = 1042744260;
     ...
     */
    public final TableField<FilmListRecord, FilmListRating> RATING = createField("rating", org.jooq.impl.SQLDataType.VARCHAR(5).defaultValue(org.jooq.impl.DSL.inline("G", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(br.com.upperapps.sakilasparkapi.jooq.enums.FilmListRating.class), this, "");
