...
import br.com.upperapps.sakilasparkapi.jooq.tables.records.CustomerListRecord;
...
public class CustomerList extends TableImpl<CustomerListRecord> {
    ...
    private static final long serialVersionUID = -1740718510;
     ...
     */
    public final TableField<CustomerListRecord, UShort> ID = createField("ID", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED)), this, "");
