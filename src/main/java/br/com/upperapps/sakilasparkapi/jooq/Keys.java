...
import br.com.upperapps.sakilasparkapi.jooq.tables.records.AddressRecord;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.CategoryRecord;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.CityRecord;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.CountryRecord;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.CustomerRecord;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.FilmActorRecord;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.FilmCategoryRecord;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.FilmRecord;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.FilmTextRecord;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.InventoryRecord;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.LanguageRecord;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.PaymentRecord;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.RentalRecord;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.StaffRecord;
import br.com.upperapps.sakilasparkapi.jooq.tables.records.StoreRecord;
...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<AddressRecord, CityRecord> FK_ADDRESS_CITY = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_CITY_PRIMARY, Address.ADDRESS, "fk_address_city", Address.ADDRESS.CITY_ID);
        public static final ForeignKey<CityRecord, CountryRecord> FK_CITY_COUNTRY = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_COUNTRY_PRIMARY, City.CITY, "fk_city_country", City.CITY.COUNTRY_ID);
        public static final ForeignKey<CustomerRecord, StoreRecord> FK_CUSTOMER_STORE = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_STORE_PRIMARY, Customer.CUSTOMER, "fk_customer_store", Customer.CUSTOMER.STORE_ID);
        public static final ForeignKey<CustomerRecord, AddressRecord> FK_CUSTOMER_ADDRESS = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_ADDRESS_PRIMARY, Customer.CUSTOMER, "fk_customer_address", Customer.CUSTOMER.ADDRESS_ID);
        public static final ForeignKey<FilmRecord, LanguageRecord> FK_FILM_LANGUAGE = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_LANGUAGE_PRIMARY, Film.FILM, "fk_film_language", Film.FILM.LANGUAGE_ID);
        public static final ForeignKey<FilmRecord, LanguageRecord> FK_FILM_LANGUAGE_ORIGINAL = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_LANGUAGE_PRIMARY, Film.FILM, "fk_film_language_original", Film.FILM.ORIGINAL_LANGUAGE_ID);
        public static final ForeignKey<FilmActorRecord, ActorRecord> FK_FILM_ACTOR_ACTOR = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_ACTOR_PRIMARY, FilmActor.FILM_ACTOR, "fk_film_actor_actor", FilmActor.FILM_ACTOR.ACTOR_ID);
        public static final ForeignKey<FilmActorRecord, FilmRecord> FK_FILM_ACTOR_FILM = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_FILM_PRIMARY, FilmActor.FILM_ACTOR, "fk_film_actor_film", FilmActor.FILM_ACTOR.FILM_ID);
        public static final ForeignKey<FilmCategoryRecord, FilmRecord> FK_FILM_CATEGORY_FILM = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_FILM_PRIMARY, FilmCategory.FILM_CATEGORY, "fk_film_category_film", FilmCategory.FILM_CATEGORY.FILM_ID);
        public static final ForeignKey<FilmCategoryRecord, CategoryRecord> FK_FILM_CATEGORY_CATEGORY = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_CATEGORY_PRIMARY, FilmCategory.FILM_CATEGORY, "fk_film_category_category", FilmCategory.FILM_CATEGORY.CATEGORY_ID);
        public static final ForeignKey<InventoryRecord, FilmRecord> FK_INVENTORY_FILM = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_FILM_PRIMARY, Inventory.INVENTORY, "fk_inventory_film", Inventory.INVENTORY.FILM_ID);
        public static final ForeignKey<InventoryRecord, StoreRecord> FK_INVENTORY_STORE = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_STORE_PRIMARY, Inventory.INVENTORY, "fk_inventory_store", Inventory.INVENTORY.STORE_ID);
        public static final ForeignKey<PaymentRecord, CustomerRecord> FK_PAYMENT_CUSTOMER = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_CUSTOMER_PRIMARY, Payment.PAYMENT, "fk_payment_customer", Payment.PAYMENT.CUSTOMER_ID);
        public static final ForeignKey<PaymentRecord, StaffRecord> FK_PAYMENT_STAFF = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_STAFF_PRIMARY, Payment.PAYMENT, "fk_payment_staff", Payment.PAYMENT.STAFF_ID);
        public static final ForeignKey<PaymentRecord, RentalRecord> FK_PAYMENT_RENTAL = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_RENTAL_PRIMARY, Payment.PAYMENT, "fk_payment_rental", Payment.PAYMENT.RENTAL_ID);
        public static final ForeignKey<RentalRecord, InventoryRecord> FK_RENTAL_INVENTORY = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_INVENTORY_PRIMARY, Rental.RENTAL, "fk_rental_inventory", Rental.RENTAL.INVENTORY_ID);
        public static final ForeignKey<RentalRecord, CustomerRecord> FK_RENTAL_CUSTOMER = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_CUSTOMER_PRIMARY, Rental.RENTAL, "fk_rental_customer", Rental.RENTAL.CUSTOMER_ID);
        public static final ForeignKey<RentalRecord, StaffRecord> FK_RENTAL_STAFF = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_STAFF_PRIMARY, Rental.RENTAL, "fk_rental_staff", Rental.RENTAL.STAFF_ID);
        public static final ForeignKey<StaffRecord, AddressRecord> FK_STAFF_ADDRESS = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_ADDRESS_PRIMARY, Staff.STAFF, "fk_staff_address", Staff.STAFF.ADDRESS_ID);
        public static final ForeignKey<StaffRecord, StoreRecord> FK_STAFF_STORE = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_STORE_PRIMARY, Staff.STAFF, "fk_staff_store", Staff.STAFF.STORE_ID);
        public static final ForeignKey<StoreRecord, StaffRecord> FK_STORE_STAFF = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_STAFF_PRIMARY, Store.STORE, "fk_store_staff", Store.STORE.MANAGER_STAFF_ID);
        public static final ForeignKey<StoreRecord, AddressRecord> FK_STORE_ADDRESS = Internal.createForeignKey(br.com.upperapps.sakilasparkapi.jooq.Keys.KEY_ADDRESS_PRIMARY, Store.STORE, "fk_store_address", Store.STORE.ADDRESS_ID);
    }
}
